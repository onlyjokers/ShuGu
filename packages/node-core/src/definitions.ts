...
function createImgScaleNode(): NodeDefinition {
  return {
    type: 'img-scale',
    label: 'Img Scale',
    category: 'Image',
...
function createImgFitNode(): NodeDefinition {
  return {
    type: 'img-fit',
    label: 'Img Fit',
    category: 'Image',
...
function createImgXYOffsetNode(): NodeDefinition {
  return {
    type: 'img-xy-offset',
    label: 'Img XY Offset',
    category: 'Image',
...
function createImgTransparencyNode(): NodeDefinition {
  return {
...
function createNumberScriptNode(): NodeDefinition {
  return {
    type: 'number-script',
    label: 'Number Script',
    category: 'Logic',
